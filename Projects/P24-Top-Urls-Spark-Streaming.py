...
# Parse out the common log formate to a DataFrame
...
logDF = accessLines.select(func.regexp_extract('value', hostExp, 1).alias('host'),
...
logsDF2 = logDF.withColumn("eventTime", func.current_timestamp())
